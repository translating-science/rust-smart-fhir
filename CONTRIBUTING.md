# Contributing to the Rust-based SMART-on-FHIR example
...
Licensing is very important to open source projects. It helps ensure the software continues to be available under the terms that the author desired. This codebase is licensed under [the Apache 2.0 license](https://github.com/translating-science/rust-smart-fhir/blob/main/LICENSE.txt).

The license tells you what rights you have that are provided by the copyright holder. It is important that the contributor fully understands what rights they are licensing and agrees to them. Sometimes the copyright holder isn't the contributor, such as when the contributor is doing work on behalf of a company.

To make a good faith effort to ensure these criteria are met, this repository requires the Developer Certificate of Origin (DCO) process to be followed.
